...
- `internal/skills/` — Embedded copies of skills for `go:embed`. Do NOT edit directly — edit `skills/` instead.
- `skills/` — Source of truth for bundled Claude Code skills.
...
5. **After editing skills**, run `go generate ./internal/skills` and commit both `skills/` and `internal/skills/`.
